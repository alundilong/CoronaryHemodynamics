...
G_BEGIN_DECLS
/* enumerations from "C:/repo/mingw-w64-json-glib/src/build-x86_64-w64-mingw32/../json-glib-1.4.2/json-glib/json-parser.h" */
JSON_AVAILABLE_IN_1_0
GType json_parser_error_get_type (void) G_GNUC_CONST;
#define JSON_TYPE_PARSER_ERROR (json_parser_error_get_type())
/* enumerations from "C:/repo/mingw-w64-json-glib/src/build-x86_64-w64-mingw32/../json-glib-1.4.2/json-glib/json-path.h" */
JSON_AVAILABLE_IN_1_0
GType json_path_error_get_type (void) G_GNUC_CONST;
#define JSON_TYPE_PATH_ERROR (json_path_error_get_type())
/* enumerations from "C:/repo/mingw-w64-json-glib/src/build-x86_64-w64-mingw32/../json-glib-1.4.2/json-glib/json-reader.h" */
JSON_AVAILABLE_IN_1_0
GType json_reader_error_get_type (void) G_GNUC_CONST;
#define JSON_TYPE_READER_ERROR (json_reader_error_get_type())
/* enumerations from "C:/repo/mingw-w64-json-glib/src/build-x86_64-w64-mingw32/../json-glib-1.4.2/json-glib/json-types.h" */
JSON_AVAILABLE_IN_1_0
